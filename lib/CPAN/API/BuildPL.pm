...
* *should* install all files generated by the build tool after the
...
* *must* additionally remove all files generated during configuration,
including but not limited to the C<Build> script and the MYMETA files
* *should not* create any files in the cleanup process
